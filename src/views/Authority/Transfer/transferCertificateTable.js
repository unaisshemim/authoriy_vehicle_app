...
const rows = [
  createData("Vehicle License", "preview"),
  createData("Mortage Paper ", "preview"),
  createData("Letter From Authority", "preview"),
];

export default function TransferCertificateTable() {
  return (
